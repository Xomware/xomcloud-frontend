...
import { UserService, TrackService, PlaylistService, ToastService } from '../../services';
...
export class MyProfileComponent implements OnInit, OnDestroy {
  ...
  private loadAdditionalData(): void {
    // Load recent tracks
    this.trackService.getLikedTracks(6)
    ...
    // Load playlists
    this.playlistService.getUserPlaylists(false, 6)
      .pipe(takeUntil(this.destroy$))
      .subscribe({
